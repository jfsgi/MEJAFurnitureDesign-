// Parametric bench: 4 legs + 4 aprons + a seat that is either a solid slab or evenly
...
export const bench: ComponentDef = {
  id: 'bench',
  name: 'Bench',
  category: 'Seating',
  description: 'Four-leg bench with a solid or slatted seat.',
  params: [
    { kind: 'length', key: 'width', label: 'Width', default: inch(48), min: inch(18), max: inch(96), tier: 'basic' },
    { kind: 'length', key: 'depth', label: 'Depth', default: inch(14), min: inch(9), max: inch(24), tier: 'basic' },
    { kind: 'length', key: 'height', label: 'Height', default: inch(18), min: inch(12), max: inch(30), tier: 'basic' },
    ...
    { kind: 'length', key: 'overhang', label: 'Seat overhang', default: inch(1.5), min: 0, max: inch(6), tier: 'advanced' },
    { kind: 'length', key: 'legWidth', label: 'Leg width', default: inch(1.75), min: inch(1), max: inch(4), tier: 'advanced' },
